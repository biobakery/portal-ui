...
Parkinson’s disease project includes men from the Health Professionals Follow-up Study (HPFS) and women from the Nurses Health Study 1 (NHS1) with Parkinson’s disease and age/BMI matched controls, targeting all patients diagnosed at time of enrollment. The Health Professionals Follow-up Study3 is the parent prospective cohort of many individual studies, with both parent and subpopulations detailed below. It was launched in 1986 with 51,529 men then aged 40-75, with approximately 50% still participating with an average age of ~80. The Nurses’ Health Studies (NHS1, NHS2, and NHS3) are a series of roughly generational parent prospective cohorts launched in 1976, 1989, and 2010, respectively, with ~100,000 initial participants each. We use “NHS” to refer predominantly to NHS2, from which most participants (all women) are still active with an average age of ~69.
<br/>
<br/>
